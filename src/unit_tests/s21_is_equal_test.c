...
START_TEST(test_s21_is_equal_sign) {
  s21_decimal val_1 = {1, 0, 0, 2147483648}, val_2 = {1, 0, 0, 0};

  ck_assert_int_eq(s21_is_equal(val_1, val_2), 0);
  ////////////////////////////////////////////////////////
  s21_decimal val_3 = {1, 0, 0, 0}, val_4 = {1, 0, 0, 2147483648};

  ck_assert_int_eq(s21_is_equal(val_3, val_4), 0);
}
END_TEST

START_TEST(test_s21_is_equal_whole) {
  s21_decimal val_1 = {1, 0, 0, 2147483648}, val_2 = {1, 0, 0, 2147483648};

  ck_assert_int_eq(s21_is_equal(val_1, val_2), 1);
  ////////////////////////////////////////////////////////
  s21_decimal val_3 = {0xffffffff, 0xffffffff, 1, 0};
  s21_decimal val_4 = {0xffffffff, 0xffffffff, 1, 0};

  ck_assert_int_eq(s21_is_equal(val_3, val_4), 1);
  ////////////////////////////////////////////////////////
  s21_decimal val_5 = {0xffffffff, 0xffffffff, 0xffffffff, 0};
  s21_decimal val_6 = {1, 0, 0, 0};

  ck_assert_int_eq(s21_is_equal(val_5, val_6), 0);
}
END_TEST

START_TEST(test_s21_is_equal_fraction) {
...
Suite *is_equal_suite(void) {
  ...
  tcase_add_test(test_case, test_s21_is_equal_sign);
  tcase_add_test(test_case, test_s21_is_equal_whole);
  tcase_add_test(test_case, test_s21_is_equal_fraction);
