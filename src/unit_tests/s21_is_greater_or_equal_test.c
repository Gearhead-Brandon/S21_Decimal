...
START_TEST(test_s21_is_greater_or_equal_equal) {
  ...
  int result_code_1 = s21_is_greater_or_equal(val_1, val_2);

  ck_assert_int_eq(result_code_1, 0);
  ////////////////////////////////////////////////////////
  s21_decimal val_3 = {1, 0, 0, 0}, val_4 = {1, 0, 0, 0};
  int result_code_2 = s21_is_greater_or_equal(val_3, val_4);

  ck_assert_int_eq(result_code_2, 1);
}
END_TEST

START_TEST(test_s21_is_greater_or_equal_greater) {
  s21_decimal val_1 = {1, 0, 0, 2147483648}, val_2 = {4, 0, 0, 2147483648};
  int result_code_1 = s21_is_greater_or_equal(val_1, val_2);

  ck_assert_int_eq(result_code_1, 1);
  ////////////////////////////////////////////////////////
  s21_decimal val_3 = {0xffffffff, 0xffffffff, 2, 0};
  ...
  int result_code_3 = s21_is_greater_or_equal(val_5, val_6);

  ck_assert_int_eq(result_code_3, 1);
}
END_TEST

START_TEST(test_s21_is_greater_or_equal_fraction) {
  ...
  ck_assert_int_eq(result_code_3, 0);
}
END_TEST
...
Suite *is_greater_or_equal_suite(void) {
  ...
  tcase_add_test(test_case, test_s21_is_greater_or_equal_equal);
  tcase_add_test(test_case, test_s21_is_greater_or_equal_greater);
  tcase_add_test(test_case, test_s21_is_greater_or_equal_fraction);
