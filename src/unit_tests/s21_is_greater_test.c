...
START_TEST(test_s21_is_greater_signs) {
  s21_decimal input_1 = {600, 1, 0, 2147483648};
  s21_decimal input_2 = {600, 2, 0, 0};

  ck_assert_int_eq(s21_is_greater(input_1, input_2), 0);

  ////////////////////////////////////////////////////////////////
  s21_decimal input_3 = {600, 1, 0, 0};
  s21_decimal input_4 = {600, 2, 0, 2147483648};

  ck_assert_int_eq(s21_is_greater(input_3, input_4), 1);
  ////////////////////////////////////////////////////////////////
  s21_decimal input_5 = {600, 1, 0, 2147483648};
  s21_decimal input_6 = {600, 2, 0, 2147483648};

  ck_assert_int_eq(s21_is_greater(input_5, input_6), 1);
  ////////////////////////////////////////////////////////////////
  s21_decimal input_7 = {600, 3, 1, 2147483648};
  s21_decimal input_8 = {600, 2, 0, 2147483648};

  ck_assert_int_eq(s21_is_greater(input_7, input_8), 0);
  ////////////////////////////////////////////////////////////////////
  s21_decimal input_9 = {2, 0, 0, 2147483648};
  s21_decimal input_10 = {1, 0, 0, 2147483648};

  ck_assert_int_eq(s21_is_greater(input_9, input_10), 0);
  ////////////////////////////////////////////////////////////////////
  s21_decimal input_11 = {1, 0, 0, 2147483648};
  s21_decimal input_12 = {2, 0, 0, 2147483648};

  ck_assert_int_eq(s21_is_greater(input_11, input_12), 1);
  ////////////////////////////////////////////////////////////////////
  s21_decimal input_13 = {1, 0, 0, 2147483648};
  s21_decimal input_14 = {1, 0, 0, 2147483648};

  ck_assert_int_eq(s21_is_greater(input_13, input_14), 0);
}
END_TEST

START_TEST(test_s21_is_greater_whole) {
  ...
  ck_assert_int_eq(s21_is_greater(input_3, input_4), 0);
  ////////////////////////////////////////////////////////////////
...
START_TEST(test_s21_is_greater_fraction) {
  s21_decimal input_1 = {600, 1, 0, 0};
  ...
  ck_assert_int_eq(s21_is_greater(input_7, input_8), 1);
  ////////////////////////////////////////////////////////////////////
  ...
  ck_assert_int_eq(s21_is_greater(input_9, input_10), 1);
  ////////////////////////////////////////////////////////////////////
  ...
  ck_assert_int_eq(s21_is_greater(input_11, input_12), 0);
  ////////////////////////////////////////////////////////////////////
  ...
  ck_assert_int_eq(s21_is_greater(input_13, input_14), 1);
  ////////////////////////////////////////////////////////////////////
  ...
  ck_assert_int_eq(s21_is_greater(input_15, input_16), 0);
  ////////////////////////////////////////////////////////////////////
  ...
  ck_assert_int_eq(s21_is_greater(input_17, input_18), 1);
  ////////////////////////////////////////////////////////////////////
  ...
  ck_assert_int_eq(s21_is_greater(input_19, input_20), 1);
}
END_TEST
...
Suite *is_greater_suite(void) {
  ...
  tcase_add_test(test_case, test_s21_is_greater_signs);
  tcase_add_test(test_case, test_s21_is_greater_whole);
  tcase_add_test(test_case, test_s21_is_greater_fraction);
