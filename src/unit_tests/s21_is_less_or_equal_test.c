...
START_TEST(test_s21_is_less_or_equal_equal) {
  ...
  ck_assert_int_eq(s21_is_less_or_equal(val_1, val_2), 1);
  ////////////////////////////////////////////////////////////
  s21_decimal val_3 = {1, 0, 0, 0}, val_4 = {1, 0, 0, 0};

  ck_assert_int_eq(s21_is_less_or_equal(val_3, val_4), 1);
}
END_TEST
...
START_TEST(test_s21_is_less_or_equal_less) {
  ...
  ck_assert_int_eq(s21_is_less_or_equal(val_1, val_2), 0);
  ////////////////////////////////////////////////////////////
  s21_decimal val_3 = {0xffffffff, 0xffffffff, 1, 0};
  s21_decimal val_4 = {0xffffffff, 0xffffffff, 2, 0};
  ...
  ck_assert_int_eq(s21_is_less_or_equal(val_5, val_6), 0);
}
END_TEST

START_TEST(test_s21_is_less_or_equal_fraction) {
  ...
  ck_assert_int_eq(s21_is_less_or_equal(val_5, val_6), 1);
}
END_TEST
...
Suite *is_less_or_equal_suite(void) {
  ...
  tcase_add_test(test_case, test_s21_is_less_or_equal_equal);
  tcase_add_test(test_case, test_s21_is_less_or_equal_less);
  tcase_add_test(test_case, test_s21_is_less_or_equal_fraction);
